...
const musicSchoolTestimonials = [
 ...
 const MusicTestimonialCards = () => {
   return (
     <section className="relative h-[40rem] w-full overflow-hidden bg-black flex flex-col items-center justify-center">
       {/* GRID BACKGROUND */}
       <div
       ...
       {/* CONTENT */}
       <h2 className="text-3xl font-bold text-center mb-10 z-10 text-white">
